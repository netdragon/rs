...
public class AdjustAdmitAction extends BaseAction
{
	...
	protected static final LogHandler logger=LogHandler.getInstance(AdjustAdmitAction.class);
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
			...
			String s_Zyid = BaseFunction.null2value(request.getParameter("lqzy_"+bmxxid));
