...
public class AddBmxxAction extends BaseAction {
    ...
    protected static final LogHandler logger = LogHandler
            .getInstance(AddBmxxAction.class);
    ...
    static {
        ...
        UPLOAD_MEMERY_FILE_SIZE = Integer.parseInt(hm_env
                .get("UPLOAD_MEMERY_FILE_SIZE"));
    }
        ...
        try {
			...
			*/
            ...
            while (iter.hasNext()) {
                ...
                if (item.isFormField()) {
                    if ("pidcardnum".equals(item.getFieldName()))
                        ksShfzh = item.getString("UTF-8");

                    if ("pname".equals(item.getFieldName()))
                        ksName = item.getString("UTF-8");
                    if ("pxb".equals(item.getFieldName()))
                        ksXb = item.getString("UTF-8");
                    if ("pwyyz".equals(item.getFieldName()))
                        ksWyyz = item.getString("UTF-8");
                    if ("pjg".equals(item.getFieldName()))
                        ksJg = item.getString("UTF-8");
                    if ("pminzu".equals(item.getFieldName()))
                        mz = item.getString("UTF-8");
                    if ("pzzmm".equals(item.getFieldName()))
                        zzmm = item.getString("UTF-8");
                    if ("psqly".equals(item.getFieldName()))
                        ksSqly = item.getString("UTF-8");

                    if ("pzxmc".equals(item.getFieldName()))
                        ksZxmc = item.getString("UTF-8");
                    if ("pkskl".equals(item.getFieldName()))
                        ksKl = item.getString("UTF-8");
                    if ("ptxdzh".equals(item.getFieldName()))
                        ksTxdzh = item.getString("UTF-8");
                    if ("pyzbm".equals(item.getFieldName()))
                        ksYzbm = item.getString("UTF-8");
                    if ("pshxr".equals(item.getFieldName()))
                        ksShxr = item.getString("UTF-8");
                    if ("pyddh".equals(item.getFieldName()))
                        ksYddh = item.getString("UTF-8");

                    if ("pfmxm".equals(item.getFieldName()))
                        ksFmname = item.getString("UTF-8");
                    if ("fmgzdw".equals(item.getFieldName()))
                        ksFmdw = item.getString("UTF-8");
                    if ("fmgzzw".equals(item.getFieldName()))
                        ksFmzw = item.getString("UTF-8");
                    if ("fmyddh".equals(item.getFieldName()))
                        ksFmShji = item.getString("UTF-8");
                    if ("pmmxm".equals(item.getFieldName()))
                        ksMmname = item.getString("UTF-8");
                    if ("mmgzdw".equals(item.getFieldName()))
                        ksMmdw = item.getString("UTF-8");
                    if ("mmgzzw".equals(item.getFieldName()))
                        ksMmzw = item.getString("UTF-8");
                    if ("mmyddh".equals(item.getFieldName()))
                        ksMmShji = item.getString("UTF-8");

                    if ("pzhiyuan1".equals(item.getFieldName()))
                        pzhiyuan1 = item.getString("UTF-8");
                    if ("pzhiyuan2".equals(item.getFieldName()))
                        pzhiyuan2 = item.getString("UTF-8");
                    if ("pzhiyuan3".equals(item.getFieldName()))
                        pzhiyuan3 = item.getString("UTF-8");

                    if ("psftj".equals(item.getFieldName()))
                        ksSftj = item.getString("UTF-8");

                    if ("pksah".equals(item.getFieldName()))
                        ksAhtc = item.getString("UTF-8");

                    if ("pzhenian1".equals(item.getFieldName()))
                        ksJlzy1 = item.getString("UTF-8");
                    if ("pzheyue1".equals(item.getFieldName()))
                        ksJlzm1 = item.getString("UTF-8");
                    if ("phjmc1".equals(item.getFieldName()))
                        ksJlmc1 = item.getString("UTF-8");
                    if ("pjsjb1".equals(item.getFieldName()))
                        ksJljb1 = item.getString("UTF-8");
                    if ("phjdj1".equals(item.getFieldName()))
                        ksJldj1 = item.getString("UTF-8");
                    if ("psjbm1".equals(item.getFieldName()))
                        ksJlbm1 = item.getString("UTF-8");

                    if ("pzhenian2".equals(item.getFieldName()))
                        ksJlzy2 = item.getString("UTF-8");
                    if ("pzheyue2".equals(item.getFieldName()))
                        ksJlzm2 = item.getString("UTF-8");
                    if ("phjmc2".equals(item.getFieldName()))
                        ksJlmc2 = item.getString("UTF-8");
                    if ("pjsjb2".equals(item.getFieldName()))
                        ksJljb2 = item.getString("UTF-8");
                    if ("phjdj2".equals(item.getFieldName()))
                        ksJldj2 = item.getString("UTF-8");
                    if ("psjbm2".equals(item.getFieldName()))
                        ksJlbm2 = item.getString("UTF-8");

                    if ("pzhenian3".equals(item.getFieldName()))
                        ksJlzy3 = item.getString("UTF-8");
                    if ("pzheyue3".equals(item.getFieldName()))
                        ksJlzm3 = item.getString("UTF-8");
                    if ("phjmc3".equals(item.getFieldName()))
                        ksJlmc3 = item.getString("UTF-8");
                    if ("pjsjb3".equals(item.getFieldName()))
                        ksJljb3 = item.getString("UTF-8");
                    if ("phjdj3".equals(item.getFieldName()))
                        ksJldj3 = item.getString("UTF-8");
                    if ("psjbm3".equals(item.getFieldName()))
                        ksJlbm3 = item.getString("UTF-8");

                    if ("phdn1".equals(item.getFieldName()))
                        ksShzy1 = item.getString("UTF-8");
                    if ("phdy1".equals(item.getFieldName()))
                        ksShzm1 = item.getString("UTF-8");
                    if ("phdmc1".equals(item.getFieldName()))
                        ksShmc1 = item.getString("UTF-8");
                    if ("phdjs1".equals(item.getFieldName()))
                        ksShjs1 = item.getString("UTF-8");
                    if ("phdn2".equals(item.getFieldName()))
                        ksShzy2 = item.getString("UTF-8");
                    if ("phdy2".equals(item.getFieldName()))
                        ksShzm2 = item.getString("UTF-8");
                    if ("phdmc2".equals(item.getFieldName()))
                        ksShmc2 = item.getString("UTF-8");
                    if ("phdjs2".equals(item.getFieldName()))
                        ksShjs2 = item.getString("UTF-8");
                    if ("phdn3".equals(item.getFieldName()))
                        ksShzy3 = item.getString("UTF-8");
                    if ("phdy3".equals(item.getFieldName()))
                        ksShzm3 = item.getString("UTF-8");
                    if ("phdmc3".equals(item.getFieldName()))
                        ksShmc3 = item.getString("UTF-8");
                    if ("phdjs3".equals(item.getFieldName()))
                        ksShjs3 = item.getString("UTF-8");
                    ...
                    if ("perphoto".equals(fieldName)) {
                        ...
                        if (s_FileName.length() > 3) {
                            ...
                            try {
                                ...
                                AttachFile attachFile = afs.addFile(s_FileName,
                                        "img", "person", sizeInBytes);
                                s_imgID = attachFile.getUUID();
                                File uploadedFile = new File(RS_HOME
                                        + APP_ATTACH_FILE_PATH
                                        + attachFile.getPath() + "/"
                                        + attachFile.getUUID());
            ...
            if (0 == ksShfzh.length()) {
                response.sendRedirect("error.jsp?error="
                        + new UTF8String("身份证号不能为空!").toUTF8String());
                return;
            }

            if (0 == ksName.length()) {
                response.sendRedirect("error.jsp?error="
                        + new UTF8String("姓名不能为空!").toUTF8String());
                return;
            }
            if (0 == ksYddh.length()) {
                response.sendRedirect("error.jsp?error="
            ...
            if (0 == ksTxdzh.length()) {
                response.sendRedirect("error.jsp?error="
                        + new UTF8String("通信地址不能为空!").toUTF8String());
                return;
            }
            if (0 == ksYzbm.length()) {
                response.sendRedirect("error.jsp?error="
            ...
            if (0 == ksShxr.length()) {
                response.sendRedirect("error.jsp?error="
                        + new UTF8String("收信人不能为空!").toUTF8String());
                return;
            }
            hasPhoto = false;
            if (!hasPhoto && (null == bmxxId)) {
                // response.sendRedirect("error.jsp?error="+new
                // UTF8String("请添加照片!").toUTF8String());
                // return;
            }
            ...
            try {
                ...
                if (ess.getMessage().indexOf("uplicate") > 0)
                    response.sendRedirect("error.jsp?error="
                            + new UTF8String("此身份证已经报过名了！不能再用此身份证报名")
                                    .toUTF8String());
                else
                    response.sendRedirect("error.jsp?error="
                            + new UTF8String("数据库访问错误！").toUTF8String());
            ...
            response.sendRedirect("error.jsp?error="
                    + new UTF8String("用户报名时发生错误！").toUTF8String());
            return;
        }
    }
}
