...
public class ExportBmxxAction extends BaseAction{
    protected static final LogHandler logger=LogHandler.getInstance(ExportBmxxAction.class);
    ...
    static {
        ...
        TEMPLATE = hm_env.get("RS_HOME").trim() + "\\data\\appfiles\\template\\bmxx_template.xls";
	...
	public static void saveExcel(String template, String fName) throws Exception{
       ...
       try{
			...
			"mmxm,mmgzdw,mmyddh,ksah,sqly,bmsj from bmxx a left join cjjd b on a.bmxxid=b.bmxxid order by a.bmxxid");
