...
public class ExportAdmitResultAction extends BaseAction{
    protected static final LogHandler logger=LogHandler.getInstance(ExportAdmitResultAction.class);
    ...
    static {
        ...
        TEMPLATE = hm_env.get("RS_HOME").trim() + "\\data\\appfiles\\template\\lq_template.xls";
    ...
    protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		InputStream inStream = null;
		 try {
			...
			response.setHeader("Content-disposition","filename=ks_lq_"+tempName+".xls");
