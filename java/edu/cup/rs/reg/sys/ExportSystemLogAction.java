...
public class ExportSystemLogAction extends BaseAction{
    protected static final LogHandler logger=LogHandler.getInstance(ExportSystemLogAction.class);
    ...
    protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		InputStream inStream = null;
		 try {
			...
			response.setHeader("Content-disposition","filename=rs_"+tempName+".log");
