...
public class ResetPwdAction  extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
	protected static final LogHandler logger=LogHandler.getInstance(ResetPwdAction.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            String password=BaseFunction.null2value(request.getParameter("passwordn"));
            ...
            try {
                ...
                user = (User)al.get(0);
				dbo.update(icl.modifyPwd(Encoder.encrypt(password),user.getUserid()));
