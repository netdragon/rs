...
public class AuditAdviceAction extends BaseAction
{

	protected static final LogHandler logger=LogHandler.getInstance(AuditAdviceAction.class);
	public AuditAdviceAction() {
		super();
	}
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
			...
			String advice = BaseFunction.null2value(request.getParameter("yj"));
            ...
            try {
				bl = new BmxxList();
				dbo.update(bl.setAuditAdvice(bmxxid, advice));
				ICommonList logslist;
				Log log = new Log();
				logslist = new LogsList();
				log.setContent(USERNAME + " 修改考生审核意见。");
