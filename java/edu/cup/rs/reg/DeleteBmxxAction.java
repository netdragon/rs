...
public class DeleteBmxxAction extends BaseAction
{
	...
	protected static final LogHandler logger=LogHandler.getInstance(DeleteBmxxAction.class);
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            response.sendRedirect("ok.jsp?info=" + new UTF8String("删除成功！").toUTF8String());
            return;
        }
        catch(Exception e)
        {
