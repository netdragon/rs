...
<table width="639" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
  <tr>
    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="34" class="tbl_a">科　类：</td>
        <td class="tbl_a cuti"><%=bmxx.getKskl()%>&nbsp;</td>
      </tr>
      <tr>
        <td height="34" class="tbl_a">身份证号：</td>
        <td class="cuti tbl_a"><%=bmxx.getShfzh()%>&nbsp;</td>
      </tr>
     <tr>
        <td height="34" class="tbl_a">考试时间：</td>
<%
...
%>
			<td class="cuti tbl_a"><%=kemu.getKmmc()%>&nbsp;<%=kssj_s%>:<%=kssj_f%>－<%=jssj_s%>:<%=jssj_f%></td>
		</tr>
<%
		}
%>
      <tr>
        <td height="34" class="tbl_a">考试地点：</td>
