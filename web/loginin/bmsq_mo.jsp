...
<table width="451" border="0" cellspacing="2" cellpadding="0" align="center" bgcolor="#EEEEEE">
 ...
 <tr>
    <td bgcolor="#FFFFFF" width="364" height="47"  class="STYLE3">1.<a href="modiinfo.jsp">修改申请表</a></td>
    
  </tr>
  <tr>
    <td height="40"  bgcolor="#FFFFFF" class="STYLE3">2.<a href="modicjjd.jsp">修改高中成绩鉴定表</a></td>
