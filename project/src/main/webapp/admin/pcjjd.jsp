...
<table width="649" border="0" align="center" cellpadding="0" cellspacing="0" class="tbl_w">
  ...
  <tr>
   <td  colspan="6" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td  width="13%" nowrap="nowrap" align="left" class="td1 STYLE6">&nbsp;&nbsp;<span class="brfnt">中学通信地址</span></td>
...
<!--<tr>
    <td width="64" align="center" class="td1 STYLE6">邮政编码</td>
    <td width="150" class="td1 STYLE6"><%=gzcjjd.getZxybm() %></td>
    <td width="66" align="center" class="td1 STYLE6">联系电话</td>
    <td width="168" class="td1 STYLE6"><%=gzcjjd.getZxlxdh() %></td>
    <td width="76" align="center" class="td1 STYLE6">年级负责人</td>
    <td width="144" class="tda2 STYLE6"><%=gzcjjd.getNjfzr() %></td>
  </tr>-->
  ...
  <tr>
    <td width="57" align="center" class="td1 STYLE6 brfnt brfnt brfnt">班主任<br />综合评价</td>
